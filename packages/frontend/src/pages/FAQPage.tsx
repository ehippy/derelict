          ...
          <div className="space-y-8">
            <FAQSection id="what-is-derelict" question="What is DERELICT?">
              <p>
                ...
                Players navigate derelict spaceships, manage stress and resources, fight
                monsters, and coordinate through Discord while exploring grid-based maps in a
                web interface. Think FTL meets Alien Isolation with Mothership RPG mechanics.
              </p>
            </FAQSection>
            ...
            >
              <p>
                ...
                when browsing servers, you'll need to request that someone with admin
                permissions adds the bot.
              </p>
              <p>
                You could also create your own Discord server and add the bot there to try it
                out!
              </p>
              <p>
            ...
            <FAQSection id="game-channel" question="What is a game channel?">
              <p>
                The game channel is where the DERELICT bot posts game updates, turn
                notifications, and atmospheric messages. We recommend creating a dedicated
                channel called{' '}
                <span className="text-indigo-400">#derelict</span> for the best experience.
                Server admins can configure this in the admin settings panel on the guild page.
              </p>
            </FAQSection>

            <FAQSection id="opt-in" question="How do I join a game?">
              <p>
                First, log in with your Discord account. Then navigate to your server's page
                and click "Join Roster" in the player roster section. Once opted in, you'll be
                ready to play when an admin starts a game session.
              </p>
            </FAQSection>
            ...
            <FAQSection id="permissions" question="What permissions does the bot need?">
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li>
                  <strong>Read Messages/View Channels</strong> - To see the game channel
                </li>
                <li>
                  <strong>Send Messages</strong> - To post game updates and notifications
                </li>
              </ul>
            </FAQSection>
            ...
            >
              <p>
                DERELICT is in active development. For bug reports, feature requests, or
                general feedback, please reach out via Discord or check the project repository
                for issue tracking.
              </p>
            </FAQSection>
          </div>
